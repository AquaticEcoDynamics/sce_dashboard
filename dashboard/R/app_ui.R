    ...
    navbarPage(
        ...
        fluidRow(
          ...
          column(
            ...
            tabsetPanel(
              ...
              tabPanel(
                title = "WeatherS3",
                weathertimeseriesUI(namespace = "weather")
              ),
            )
          )
        )
        ...
        fluidRow(
          ...
          column(
            ...
            tabsetPanel(
              ...
              #   subGroup = "Catch"
              # ),
              # dateRangeUI(namespace = "wqCatch"),
              # #),
              # plotOutput("wqCatchPlot", height = "400px"),
              # dateSliderUI(namespace = "wqCatch")
              # ),
              ...
              tabPanel(
                title = "Profiles",
                profileplotsUI(namespace = "wqProf")
                ),
              tabPanel(
                title="Mooring",
                tags$summary(HTML("Select sites and date range:")),
                ...
                dateRangeUI(namespace = "wqMooring"),
                plotOutput("wqMooringPlot", height = "400px"),
                dateSliderUI(namespace = "wqMooring")
              ),
              )
            )
              )
      ...
      tabPanel(
        ...
        fluidRow(
          column(
            4,
            leaflet::leafletOutput("oxyplantMap", height = '700px')
          ),
          column(
            8,
            tabsetPanel(
      ...
      tabPanel(
        ...
        fluidRow(
          column(
            4,
            leaflet::leafletOutput("habMap", height = '700px')
          ),
          column(
            8,
            tabsetPanel(
