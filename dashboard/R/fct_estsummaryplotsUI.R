      ...
      wellPanel(
        fluidRow(
          ...
          column(3,selectInput("select_year",
                               label = "Select year" ,
                               choices = years,  #these choices are given based on region selected (in app_server.R)
                               selected = NULL),
                               style="margin-top: 50px;"),
          column(3,selectInput("select_vars",
                               label = "Select variable" ,
                               choices = vars,  #these choices are given based on region selected (in app_server.R)
                               selected = NULL),
                 style="margin-top: 50px;"),
